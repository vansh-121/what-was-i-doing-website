        ...
        <div className="max-w-4xl mx-auto">
          <div className="vscode-window">
            <div className="flex items-center gap-2 px-4 py-3 border-b border-border/50">
              ...
              <span className="text-sm text-primary">What Was I Doing</span>
            </div>
            ...
            <div className="p-6 space-y-6">
              {settings.map((setting, index) => (
                <div
                  key={index}
                  className="flex flex-col md:flex-row md:items-center gap-4 p-4 rounded-xl bg-secondary/30 border border-border/50 hover:border-primary/30 transition-colors"
                >
